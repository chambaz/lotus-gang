    ...
    <>
      <Section
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center px-6 pt-2 pb-3 mt-2 text-sm text-white uppercase transition border-2 rounded-full md:mt-0 md:ml-4 border-lotus-red font-lotus-pixelmix bg-lotus-red hover:bg-transparent hover:text-lotus-red">
          Buy now on
          <div
            className="flex items-center ml-3"
            style={{ transform: 'translateY(1px)' }}>
