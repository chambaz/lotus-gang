...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-0 right-0 z-40 flex items-end h-screen transition duration-1000 opacity-0 pointer-events-none w-60 md:w-1/2"
        style={{
        ...
        <img
          ...
          style={{ maxHeight: windowHeight - 100 }}
        />
      </div>
    </>
  )
