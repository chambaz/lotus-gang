  ...
  return (
    <div
      ...
      <div className="px-8 2xl:container 2xl:mx-auto">
        <Parallax offset={75}>
          <h1
            className={`${underlinePos} text-black inline-block z-20 uppercase text-5xl md:text-7xl font-lotus-pixelmix-bold relative after:content-[''] after:block after:absolute after:w-screen after:h-2 after:mt-4 after:bg-lotus-red`}>
            {title}
          </h1>
        </Parallax>
        <Parallax offset={50}>
